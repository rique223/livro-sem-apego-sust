...
export default {
      ...
      previewImage: [
        {
          ...
          title:
            "Foto Principal: <strong>(Tamanho Máx. 5MB e Extensão .png ou .jpg)</strong>",
          circle: false,
        },
      ],
      book: {},
  ...
  created() {
    var optionsSlct = this.$http.get(window.APIUrl + "/book/selects", {
    ...
    var book = this.$http.get(window.APIUrl + "/book/edit/" + book_id, {
      headers: auth.getAuthHeader(),
    });
